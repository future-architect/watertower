...
func (o *GetIndexDocIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetIndexDocIDURL")
	}
	...
	if index != "" {
		...
		return nil, errors.New("index is required on GetIndexDocIDURL")
	}
...
func (o *GetIndexDocIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetIndexDocIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetIndexDocIDURL")
	}

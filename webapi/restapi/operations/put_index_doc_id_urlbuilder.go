...
func (o *PutIndexDocIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on PutIndexDocIDURL")
	}
	...
	if index != "" {
		...
		return nil, errors.New("index is required on PutIndexDocIDURL")
	}
...
func (o *PutIndexDocIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutIndexDocIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutIndexDocIDURL")
	}

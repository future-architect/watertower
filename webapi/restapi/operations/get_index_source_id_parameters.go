...
// NewGetIndexSourceIDParams creates a new GetIndexSourceIDParams object
// no default values defined in spec.
func NewGetIndexSourceIDParams() GetIndexSourceIDParams {

	return GetIndexSourceIDParams{}
}

// GetIndexSourceIDParams contains all the bound params for the get index source id operation
...
func (o *GetIndexSourceIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetIndexSourceIDParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
